...
module.exports = {
  ...
  output: {
    ...
    // publicPath: 'dist/'     //打包的文件目录,使用HtmlWebpackPlugin时不再需要
  },
  module: {
    rules: [
      {
  ...
  plugins: [  // webpack vue-loader was used without the corresponding plugin. Make sure to include VueLoaderPlugin
    new VueLoaderPlugin(),    // 需要处理vue中的样式时，安装vue-style-loader，并配置插件
    new HtmlWebpackPlugin({
      template: 'index.html'   //根据index.html生成dist中新的index.html
    }),
    new UglifyJsPlugin()
  ]
}